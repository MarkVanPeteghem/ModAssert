...
MA_TEST(Macro_IF_MOD_ASSERT_REPORTS_OffOn)
{
	int a=0;
...
MA_TEST(Macro_IF_MOD_ASSERT_REPORTS_MultipleDeclarations_OffOn)
{
	int a=0;
...
MA_TEST(Macro_IF_MOD_ASSERT_REPORTS_With_Parameters_And_OptionalAction_OffOn)
{
	int a=0;
	IF_MOD_ASSERT_REPORTS(int old_a=a;)
...
MA_TEST(Macro_IF_MOD_CHECK_REPORTS_OffOn)
{
	int a=0;
...
MA_TEST(Macro_IF_MOD_CHECK_REPORTS_MultipleDeclarations_OffOn)
{
	int a=0;
...
MA_TEST(Macro_IF_NOT_MOD_ASSERT_REPORTS_OffOn)
{
...
MA_TEST(Macro_IF_MOD_ASSERT_REPORTS_ELSE_OffOn)
{
	int a=1;
	++a;
...
MA_TEST(Macro_IF_NOT_MOD_CHECK_REPORTS_OffOn)
{
	int b=1;
...
MA_TEST(Macro_IF_MOD_CHECK_REPORTS_ELSE_OffOn)
{
	int a=1;
	++a;

	// this will give compile error if IF_MOD_CHECK_REPORTS_ELSE doesn't work well
	IF_MOD_CHECK_REPORTS_ELSE(int b=1;, int a=1;)
