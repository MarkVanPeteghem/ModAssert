...
MA_TEST(Check_Pass_1DefaultParam)
{
	int a=2;
...
MA_TEST(CheckV_Pass_1DefaultParam)
{
	int a=2;
...
MA_TEST(CheckB_Pass_1DefaultParam)
{
	int a=2;
...
MA_TEST(CheckNoPass_1DefaultParam)
{
	int a=2;

	EXPECT_CHECK(false, "a==1", NULL, CreateParameterList()("def", def), NULL);
	MOD_CHECK(a==1, ++a);
	META_ASSERT(a==3);

	EXPECT_CHECK(false, "a==1", NULL, CreateParameterList()("a", a)("def", def), NULL);
	MOD_CHECK_P(a, a==1, ++a);
	META_ASSERT(a==4);

	EXPECT_CHECK_G(false, "a==1", NULL, CreateParameterList()("def", def), ModAssert::Error, NULL);
	MOD_CHECK_G(ModAssert::Error, a==1, ++a);
	META_ASSERT(a==5);

	EXPECT_CHECK_G(false, "a==1", NULL, CreateParameterList()("a", a)("def", def), ModAssert::Error, NULL);
	MOD_CHECK_PG(a, ModAssert::Error, a==1, ++a);
	META_ASSERT(a==6);

	EXPECT_CHECK(false, "a==1", NULL, CreateParameterList()("def", def), "--a");
	MOD_CHECK_O(--a, "--a", a==1, ++a);
	META_ASSERT(a==7);

	EXPECT_CHECK(false, "a==1", NULL, CreateParameterList()("a", a)("def", def), "--a");
	MOD_CHECK_PO(a, --a, "--a", a==1, ++a);
	META_ASSERT(a==8);

	EXPECT_CHECK_G(false, "a==1", NULL, CreateParameterList()("def", def), ModAssert::Error, "--a");
	MOD_CHECK_GO(ModAssert::Error, --a, "--a", a==1, ++a);
	META_ASSERT(a==9);

	EXPECT_CHECK_G(false, "a==1", NULL, CreateParameterList()("a", a)("def", def), ModAssert::Error, "--a");
	MOD_CHECK_PGO(a, ModAssert::Error, --a, "--a", a==1, ++a);
	META_ASSERT(a==10);
}

MA_TEST(CheckV_NoPass_1DefaultParam)
{
	int a=2;
	...
	EXPECT_CHECK(false, "a==1", NULL, CreateParameterList()("n", n)("def", def), NULL);
	...
	EXPECT_CHECK_G(false, "a==1", NULL, CreateParameterList()("n", n)("def", def), ModAssert::Error, NULL);
	...
	EXPECT_CHECK(false, "a==1", NULL, CreateParameterList()("n", n)("def", def), "++a");
	...
	EXPECT_CHECK_G(false, "a==1", NULL, CreateParameterList()("n", n)("def", def), ModAssert::Error, "++a");
	MOD_CHECK_VPGO((n), ModAssert::Error, inc_a, "++a", a==1, inc_a);
	META_ASSERT(a==10);
}

MA_TEST(CheckB_NoPass_1DefaultParam)
{
	int a=2;
	IF_MOD_CHECK_REPORTS(int n=0;)
...
MA_TEST(CheckNoPass2_1DefaultParam)
{
	int a=2;
...
MA_TEST(CheckFail_1DefaultParam)
{
	int a=2;

	EXPECT_CHECK_FAIL(false, NULL, NULL, CreateParameterList()("def", def), NULL);
	MOD_CHECK_FAIL(++a);
	META_ASSERT(a==3);

	EXPECT_CHECK_FAIL(false, NULL, NULL, CreateParameterList()("a", a)("def", def), NULL);
	MOD_CHECK_FAIL_P(a, ++a);
	META_ASSERT(a==4);

	EXPECT_CHECK_FAIL_G(false, NULL, NULL, CreateParameterList()("def", def), ModAssert::Error, NULL);
	MOD_CHECK_FAIL_G(ModAssert::Error, ++a);
	META_ASSERT(a==5);

	EXPECT_CHECK_FAIL_G(false, NULL, NULL, CreateParameterList()("a", a)("def", def), ModAssert::Error, NULL);
	MOD_CHECK_FAIL_PG(a, ModAssert::Error, ++a);
	META_ASSERT(a==6);

	EXPECT_CHECK_FAIL(false, NULL, NULL, CreateParameterList()("def", def), "--a");
	MOD_CHECK_FAIL_O(--a, "--a", ++a);
	META_ASSERT(a==7);

	EXPECT_CHECK_FAIL(false, NULL, NULL, CreateParameterList()("a", a)("def", def), "--a");
	MOD_CHECK_FAIL_PO(a, --a, "--a", ++a);
	META_ASSERT(a==8);

	EXPECT_CHECK_FAIL_G(false, NULL, NULL, CreateParameterList()("def", def), ModAssert::Error, "--a");
	MOD_CHECK_FAIL_GO(ModAssert::Error, --a, "--a", ++a);
	META_ASSERT(a==9);

	EXPECT_CHECK_FAIL_G(false, NULL, NULL, CreateParameterList()("a", a)("def", def), ModAssert::Error, "--a");
	MOD_CHECK_FAIL_PGO(a, ModAssert::Error, --a, "--a", ++a);
	META_ASSERT(a==10);
}

MA_TEST(CheckFail2_1DefaultParam)
{
	int a=2;
