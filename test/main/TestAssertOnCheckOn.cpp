...
MA_TEST(Macro_IF_MOD_ASSERT_REPORTS_OnOn)
{
	int a=0;
...
MA_TEST(Macro_IF_MOD_ASSERT_REPORTS_MultipleDeclarations_OnOn)
{
	int a=0;
...
MA_TEST(Macro_IF_MOD_ASSERT_REPORTS_With_Parameters_And_OptionalAction_OnOn)
{
	int a=0;
	IF_MOD_ASSERT_REPORTS(int old_a=a;)
...
MA_TEST(Macro_IF_MOD_CHECK_REPORTS_OnOn)
{
	int a=0;
...
MA_TEST(Macro_IF_MOD_CHECK_REPORTS_MultipleDeclarations_OnOn)
{
	int a=0;
...
MA_TEST(Macro_IF_NOT_MOD_ASSERT_REPORTS_OnOn)
{
	int b=1;
...
MA_TEST(Macro_IF_MOD_ASSERT_REPORTS_ELSE_OnOn)
{
	int a=1;
	++a;
...
MA_TEST(Macro_IF_NOT_MOD_CHECK_REPORTS_OnOn)
{
	int b=1;
...
MA_TEST(Macro_IF_MOD_CHECK_REPORTS_ELSE_OnOn)
{
	int a=1;
	++a;
