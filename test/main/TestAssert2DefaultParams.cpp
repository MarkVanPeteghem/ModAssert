...
MA_TEST(Assert_Pass_2DefaultParams)
{
	EXPECT_NO_FAILURE;
...
MA_TEST(Verify_Pass_2DefaultParams)
{
	EXPECT_NO_FAILURE;
...
MA_TEST(VerifyV_Pass_2DefaultParams)
{
	EXPECT_NO_FAILURE;
...
MA_TEST(Assert_NoPass_2DefaultParams)
{
	int a=2;

	EXPECT_ASSERT(false, "a==1", NULL, CreateParameterList()("def1", def1)("def2", def2), NULL);
	MOD_ASSERT(a==1);
	EXPECT_ASSERT(false, "a==1", NULL, CreateParameterList()("a", a)("def1", def1)("def2", def2), NULL);
	MOD_ASSERT_P(a, a==1);
	EXPECT_ASSERT(false, "a==1", NULL, CreateParameterList()("a", a)("a+1", a+1)("def1", def1)("def2", def2), NULL);
	MOD_ASSERT_P(a<<a+1, a==1);
	EXPECT_ASSERT_G(false, "a==1", NULL, CreateParameterList()("def1", def1)("def2", def2), ModAssert::Error, NULL);
	MOD_ASSERT_G(ModAssert::Error, a==1);
	EXPECT_ASSERT_G(false, "a==1", NULL, CreateParameterList()("a", a)("def1", def1)("def2", def2), ModAssert::Error, NULL);
	MOD_ASSERT_PG(a, ModAssert::Error, a==1);

	EXPECT_ASSERT(false, "a==1", NULL, CreateParameterList()("def1", def1)("def2", def2), "++a");
	MOD_ASSERT_O(++a, "++a", a==1);
	EXPECT_ASSERT(false, "a==1", NULL, CreateParameterList()("a", a)("def1", def1)("def2", def2), "++a");
	MOD_ASSERT_PO(a, ++a, "++a", a==1);
	EXPECT_ASSERT_G(false, "a==1", NULL, CreateParameterList()("def1", def1)("def2", def2), ModAssert::Error, "++a");
	MOD_ASSERT_GO(ModAssert::Error, ++a, "++a", a==1);
	EXPECT_ASSERT_G(false, "a==1", NULL, CreateParameterList()("a", a)("def1", def1)("def2", def2), ModAssert::Error, "++a");
...
MA_TEST(Verify_NoPass_2DefaultParams)
{
	int a=2;
...
MA_TEST(VerifyV_NoPass_2DefaultParams)
{
	int a=2;
	Inc inc_a(a);
...
MA_TEST(Fail_2DefaultParams)
{
	int a=2;

	EXPECT_FAIL(false, NULL, NULL, CreateParameterList()("def1", def1)("def2", def2), NULL);
	MOD_FAIL;

	EXPECT_FAIL(false, NULL, NULL, CreateParameterList()("a", a)("def1", def1)("def2", def2), NULL);
	MOD_FAIL_P(a);

	EXPECT_FAIL(false, NULL, NULL, CreateParameterList()("a", a)("a+1", a+1)("def1", def1)("def2", def2), NULL);
	MOD_FAIL_P(a << a+1);

	EXPECT_FAIL_G(false, NULL, NULL, CreateParameterList()("def1", def1)("def2", def2), ModAssert::Error, NULL);
	MOD_FAIL_G(ModAssert::Error);

	EXPECT_FAIL_G(false, NULL, NULL, CreateParameterList()("a", a)("def1", def1)("def2", def2), ModAssert::Error, NULL);
	MOD_FAIL_PG(a, ModAssert::Error);

	EXPECT_FAIL(false, NULL, NULL, CreateParameterList()("def1", def1)("def2", def2), "++a");
	MOD_FAIL_O(++a, "++a");

	EXPECT_FAIL(false, NULL, NULL, CreateParameterList()("a", a)("def1", def1)("def2", def2), "++a");
	MOD_FAIL_PO(a, ++a, "++a");

	EXPECT_FAIL_G(false, NULL, NULL, CreateParameterList()("def1", def1)("def2", def2), ModAssert::Error, "++a");
	MOD_FAIL_GO(ModAssert::Error, ++a, "++a");

	EXPECT_FAIL_G(false, NULL, NULL, CreateParameterList()("a", a)("def1", def1)("def2", def2), ModAssert::Error, "++a");
